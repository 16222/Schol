Add-Type -Path "..\Schol\Project\System.Data.SQLite\2010\bin\System.Data.SQLite.dll" 
...
$sql.CommandText = "INSERT INTO test (message) VALUES (@message)"; #testing insert statements
